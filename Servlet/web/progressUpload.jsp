...
<iframe name="upload iframe" width="0" height="0"></iframe>

<form action="/ProgressUploadServlet" method="post" enctype="multipart/form-data" target="upload iframe" onsubmit="showStatus(); ">
...
<script type="text/javascript">
    ...
    function requestStatus() {
        ...
        req.open("GET", "/ProgressUploadServlet")
