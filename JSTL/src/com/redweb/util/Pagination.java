...
public class Pagination
{
    ...
    public String toString()
    {
        ...
        buffer.append("function redweb_enter(){");
        buffer.append(" if(event.keyCode == 13){");
        buffer.append("     redweb_goto();");
        ...
        buffer.append("} ");
        buffer.append("function redweb_goto(){");
        buffer
        ...
        buffer.append("}");
        buffer
                .append("document.getElementsByName('ibm_crl_scm_goto_input')[0].onkeypress = redweb_enter;");
        buffer
                .append("document.getElementsByName('ibm_crl_scm_goto_button')[0].onclick = redweb_goto;");
